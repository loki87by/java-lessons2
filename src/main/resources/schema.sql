...
CREATE TABLE IF NOT EXISTS feed_types (
    ...
    --1 = Something with alone entity
    --2 = Entity1 impact to entity2
    --3 = Entity change param1 to param2
    --4 = Entity1 does something with entity2 to entity3
    --5 = Entity1 affected entity2 but param1 change to param2
    );

CREATE TABLE IF NOT EXISTS feed_relations (
    id int generated by default as identity primary key,
